...
namespace Eco.Mods.TechTree
{
    ...
    public partial class DrinksBarObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            storage.Storage.AddInvRestriction(new StackLimitRestriction(300));
...

            {
                this.GetComponent<PartsComponent>().Config(() => LocString.Empty, new PartInfo[]
                {
                                        ...
                                        new() { TypeName = nameof(CocktailShakerItem), Quantity = 1},
                                    });
            }
    ...
    [LocDescription("For making drinks.")]
    [Ecopedia("Work Stations", "Economic", createAsSubPage: true)]
    [Weight(3000)] // Defines how heavy DrinksBar is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    [AllowPluginModules(Tags = new[] { "AdvancedUpgrade" }, ItemTypes = new[] { typeof(MixologyUpgradeItem) })] //noloc
    public partial class DrinksBarItem : WorldObjectItem<DrinksBarObject>, IPersistentData, INullCurrencyAllowed
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext(0 | DirectionAxisFlags.Down, WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName = typeof(DrinksBarObject).UILink(),
        ...
        public DrinksBarRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(GlassBottleItem), 30, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),
                    new IngredientElement(typeof(CocktailGlassItem), 30, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),
                    new IngredientElement(typeof(EmptyPaperCupItem), 30, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),
                    new IngredientElement(typeof(BlenderItem), 1, true),
                    new IngredientElement(typeof(IceboxItem), 1, true),//noloc
                },
