...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(9)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Living Room", subPageName: "The Orrery Mini Item")]
    [RepairRequiresSkill(typeof(BasicEngineeringSkill), 2)]
    [RepairRequiresSkill(typeof(SelfImprovementSkill), 5)]
    public partial class TheOrreryMiniObject : WorldObject, IRepresentsItem
    {
        private OnOffComponent switchComponent;


        public virtual Type RepresentedItemType => typeof(TheOrreryMiniItem);
        public override LocString DisplayName => Localizer.DoStr("The Orrery Mini");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        static TheOrreryMiniObject()
        {

            WorldObject.AddOccupancy<TheOrreryMiniObject>(new List<BlockOccupancy>(){
        ...
        class TheOrreryMiniMessagesContainer : OnOffComponent.IOnOffMessagesContainer
        {
            ...
            public LocString NotAuthedMessage => Localizer.DoStr("You are not authorized to On/Off this The Orrery Mini.");
            public LocString InvalidStatusMessage => Localizer.DoStr("This Orrery Mini has an invalid status and cannot ineract.");
        }

        static TheOrreryMiniMessagesContainer msgContainer = new TheOrreryMiniMessagesContainer();
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = TheOrreryMiniItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("The Orrery Mini")]
    [LocDescription("An The Orrery Mini is a Miniature mechanical model of the Solar System that shows the relative positions and motions of the planets and moons according to the heliocentric (Sun-centred) model.")]
    [Ecopedia("Housing Objects", "Living Room", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(1500)]
    public partial class TheOrreryMiniItem : WorldObjectItem<TheOrreryMiniObject>
    {
        ...
        {
            ObjectName = typeof(TheOrreryMiniObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Living Room", subPageName: "The Orrery Mini Item")]
    public partial class TheOrreryMiniRecipe : RecipeFamily
    {
        public TheOrreryMiniRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "TheOrreryMini",  //noloc
                displayName: Localizer.DoStr("The Orrery Mini"),
                ...
                {
                    new CraftingElement<TheOrreryMiniItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TheOrreryMiniRecipe), start: 15f, skillType: typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));

           
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("The Orrery Mini"), recipeType: typeof(TheOrreryMiniRecipe));
            this.ModsPostInitialize();
